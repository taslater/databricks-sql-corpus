// GENERATED by scripts/patch_grammar.py from grammar/vendor/SqlBaseParser.g4 -- do not edit.
// Java actions rewritten for the ANTLR Python target; @members ported to
// dbsqlparse.antlr_base.SqlBaseParserBase, attached via superClass.
/*
...
options { tokenVocab = SqlBaseLexer; superClass = SqlBaseParserBase; }
...
primaryExpression
    ...
    | base=primaryExpression COLON path=variantPath                                    #variantExtract
...
dataType
    ...
    | complex=OBJECT LT complexColTypeList? GT                   #complexDataType
...
stringLit
    : STRING_LITERAL
    | {not self.double_quoted_identifiers}? DOUBLEQUOTED_STRING
    ;
